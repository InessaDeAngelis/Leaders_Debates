...
ces2019_EN_debate <- ces2019_pol_interest |>
  select(-c(cps19_debate_fr, cps19_premier_name, cps19_finmin_name)) |>
...
ces2019_FR_debate <- ces2019_pol_interest |>
  select(-c(cps19_debate_en, cps19_premier_name, cps19_finmin_name)) |>
...
ces2021_EN_debate <- ces2021_pol_interest |>
  select(-c(cps21_debate_fr, cps21_premier_name, cps21_finmin_name)) |>
...
ces2021_FR_debate <- ces2021_pol_interest |>
  select(-c(cps21_debate_en, cps21_premier_name, cps21_finmin_name)) |>
