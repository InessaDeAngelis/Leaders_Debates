...
recoded_ces2008 = 
  ...
  mutate("important_issues" = case_when( 
    ...
    important_issues == "Taxation issues" ~ "Economy",
    important_issues == "General mention: debt, finances" ~ "Economy",
    important_issues == "Balance the budget / Budget" ~ "Economy",
    important_issues == "Government spending, government waste" ~ "Economy",
...
recoded_ces2011 = 
  ...
  mutate("important_issues" = case_when( 
    ...
    important_issues == "Taxation issues (includes HST)" ~ "Economy",
    important_issues == "General mention: debt, finances, deficit" ~ "Economy",
    important_issues == "Balance the budget / Budget" ~ "Economy",
    important_issues == "Government spending, government waste" ~ "Economy",
    important_issues == "Educational issues, programs & funding" ~ "Education",
    important_issues == "Ethics&effectiveness: accountability/transparency/leadership" ~ "Ethics",
...
recoded_ces2015 = 
  ...
  mutate("important_issues" = case_when( 
    ...
    important_issues == "Balance the budget / Budget" ~ "Economy",
    important_issues == "Government spending, government waste" ~ "Economy",
    important_issues == "Income splitting" ~ "Economy",
    important_issues == "Balance the budget / budget" ~ "Economy",
    important_issues == "Educational issues, programs & funding" ~ "Education",
