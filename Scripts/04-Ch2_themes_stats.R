...
debate_questions_themes <-
  ...
  mutate("Theme" = case_when(
    ...
    Theme == "Canada's Democracy" ~ "Governance and democracy",
    Theme == "Jobs" ~ "Jobs", 
    ...
    Theme == "Governance, democracy, and institutions" ~ "Governance and democracy",
    Theme == "Leadership and governance" ~ "Governance and democracy",
    Theme == "Governance and democracy" ~ "Governance and democracy",
    Theme == "Government services" ~ "Government and citizen services",
    Theme == "Canadian Security" ~ "Canadian security",
    Theme == "Social Policy & Governance" ~ "Social welfare",
    Theme == "Environment" ~ "Environment and energy",
    Theme == "Climate Change" ~ "Environment and energy",
    Theme == "polarization, human rights, and immigration" ~ "Immigration",
    Theme == "affordability and income security"  ~ "Affordability",
    Theme == "Foreign Affairs & Immigration" ~ "Foreign affairs",
    Theme == "Citizen Services" ~ "Government and citizen services",
    Theme == "Identity, Ethics, & Governence" ~ "Governance and democracy",
    ...
    Theme == "Quebec's place in Canada" ~ "Governance and Quebec",
    Theme == "Values" ~ "Values",
    Theme == "Social policy" ~ "Social welfare",
    Theme == "Social Policy" ~ "Social welfare",
    Theme == "Governance & Quebec" ~"Governance and Quebec",
    Theme == "Affordability" ~ "Affordability",
    Theme == "LEADERSHIP AND ACCOUNTABILITY" ~ "Governance and democracy")) 
