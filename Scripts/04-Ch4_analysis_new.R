...
time_dataset <- data.frame(
  ...
  Non_leader_participation = c(19.8, 9.8, 9.7, 18.6, 19.7, 12.3, 17.2, 11.7, 16.7, 13.2, 26.6, 21.4, 16.8, 34.9, 36.8, 21.7),
  Actual_length = c(119, 118, 118, 120, 120, 88, 120, 108, 120, 86, 128, 122, 120, 126, 120, 120),
  Number_of_Segments = c(19, 16, 13, 13, 15, 12, 18, 13, 25, 5, 27, 18, 22, 29, 5, 25))
  time_dataset
